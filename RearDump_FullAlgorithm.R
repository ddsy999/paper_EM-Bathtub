...
annealingSchedule = seq(0.8,0.9999,length.out=maxIterAnnealing)
...
for( ITerAnneal in 1:maxIterAnnealing){
  ...
  for( iter in 1:maxEMIter){ 
    ...
    # bp1=bpBase
    # for( i in 1:10000){
    #   oldBp_beta1 = barrier_beta1(candi_before_vec[1],latentZ_mat,bp=bp1 )
    ...
    #   newBp_beta1 = barrier_beta1(candi_before_vec[1],latentZ_mat,bp=bp1 )
    #   if(bp1>1e+5|| abs(oldBp_beta1-newBp_beta1)<tot){break}
    # }
    # 
    # bp3=bpBase
    # for( i in 1:10000){
    #   oldBp_beta3 = barrier_beta3(candi_before_vec[3],latentZ_mat,bp=bp3 )
    #   # print(new_beta3)
    ...
    #   newBp_beta3 = barrier_beta3(candi_before_vec[3],latentZ_mat,bp=bp3 )
    #   if(bp3>1e+5|| abs(oldBp_beta3-newBp_beta3)<tot){break}
    # }
    # new_beta1 = newBp_beta1
    # new_beta3 = newBp_beta3
